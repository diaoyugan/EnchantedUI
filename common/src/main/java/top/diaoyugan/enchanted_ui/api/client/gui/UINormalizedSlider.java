...
/** General-purpose compact slider bound to a normalized value in the range [0, 1]. */
public class UINormalizedSlider extends AbstractWidget {
    private final DoubleSupplier value;
    private final DoubleConsumer setter;
    private final UITheme theme;
    public UINormalizedSlider(int x,int y,int width,int height,Component narration,DoubleSupplier value,DoubleConsumer setter){
        this(x,y,width,height,narration,value,setter,UIThemes.current());
    }
    public UINormalizedSlider(int x,int y,int width,int height,Component narration,DoubleSupplier value,DoubleConsumer setter,UITheme theme){
