package top.diaoyugan.enchanted_ui.config;
...
import top.diaoyugan.enchanted_ui.utils.logging.Logger;
import top.diaoyugan.enchanted_ui.utils.logging.LoggerLevels;
...
public class Config {
    private final Path configFilePath = Paths.get("config/veinmine.json");
