...
@ApiStatus.Internal
public final class FormInteractionRegistry {
    ...
    public FormInteractionRegistry() {}

    public void onKeyPressed(Predicate<KeyEvent> handler) {
        keyPressedHandlers.add(handler);
    }

    public void onKeyReleased(Predicate<KeyEvent> handler) {
